...
@Component({
  selector: 'app-all-show-bucks',
  templateUrl: './all-show-bucks.component.html',
  styleUrls: ['./all-show-bucks.component.scss'],
})
export class AllShowBucksComponent implements OnInit {
  tableView = false
  loader = true
  allFlyers: any
  loaderData = [9, 8, 6]
